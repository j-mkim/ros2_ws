...
#include "diffbot_description/diffbot_system.hpp"
...
hardware_interface::return_type diffbot_description ::DiffDriveArduinoHardware::write(
  const rclcpp::Time & /*time*/, const rclcpp::Duration & /*period*/)
{
  if (!comms_.connected())
  {
...
PLUGINLIB_EXPORT_CLASS(
  diffbot_description::DiffDriveArduinoHardware, hardware_interface::SystemInterface)
